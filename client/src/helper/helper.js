...
export async function generateOTP(username){
    try {
        ...
        if(status === 201){
            ...
            await axios.post('http://localhost:8080api/registerMail', { username, userEmail: email, text, subject : "Password Recovery OTP"})
        }
